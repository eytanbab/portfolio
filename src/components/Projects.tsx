...
const Projects = () => {
  ...
  return (
    <div className='flex flex-col gap-2 w-full p-4 text-seashellPeach-50 items-center justify-center mt-12 lg:mt-48'>
      <h1 className='max-w-[570px] lg:max-w-full text-3xl uppercase text-left w-full xl:max-w-7xl ml-2'>
        Projects
      </h1>
      {/* Project container */}
